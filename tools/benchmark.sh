...
OPENMP_CAT_ON_TREE="openmp,$COT_BASENAME,7,180,1.25"
PTHREADS_CAT_ON_TREE="pthreads,$COT_BASENAME,7,180,1.25"
CUDA_CAT_ON_TREE="cuda,$COT_BASENAME,7,180,1.25"
COT="$SEQUENTIAL_CAT_ON_TREE;$OPENMP_CAT_ON_TREE;$PTHREADS_CAT_ON_TREE;$CUDA_CAT_ON_TREE;"

COTS_BASENAME="$COT_BASENAME (Small)"
SEQUENTIAL_CAT_ON_TREE_SMALL="sequential,$COTS_BASENAME,7,180,1.25"
OPENMP_CAT_ON_TREE_SMALL="openmp,$COTS_BASENAME,7,180,1.25"
PTHREADS_CAT_ON_TREE_SMALL="pthreads,$COTS_BASENAME,7,180,1.25"
CUDA_CAT_ON_TREE_SMALL="cuda,$COTS_BASENAME,7,180,1.25"
...
SEQUENTIAL_CAT_ON_TREE_MEDIUM="sequential,$COTM_BASENAME,7,180,1.25"
OPENMP_CAT_ON_TREE_MEDIUM="openmp,$COTM_BASENAME,7,180,1.25"
PTHREADS_CAT_ON_TREE_MEDIUM="pthreads,$COTM_BASENAME,7,180,1.25"
CUDA_CAT_ON_TREE_MEDIUM="cuda,$COTM_BASENAME,7,180,1.25"
...
SEQUENTIAL_CAT_ON_TREE_LARGE="sequential,$COTL_BASENAME,7,180,1.25"
OPENMP_CAT_ON_TREE_LARGE="openmp,$COTL_BASENAME,7,180,1.25"
PTHREADS_CAT_ON_TREE_LARGE="pthreads,$COTL_BASENAME,7,180,1.25"
